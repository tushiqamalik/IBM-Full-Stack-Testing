...
//      // Create a new instance of the Firefox driver
        ...
        WebElement nav = driver.findElement(By.id("moduleTab_9_Accounts"));
        nav.click();

        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[4]/div/div[3]/form[2]/div[3]/table")));

        WebElement table = driver.findElement(By.xpath("/html/body/div[4]/div/div[3]/form[2]/div[3]/table/tbody"));
